$(document).ready(function () {
    ...
    if (usuarioLogeado) {
        ...
        for (let i = 0; i < publicacionesMias.length; i++) {
            let publicacion = generarPerfilHTML(publicacionesMias[i].fecha, publicacionesMias[i].nombreUsuario, publicacionesMias[i].texto, publicacionesMias[i].likes, publicacionesMias[i].fotoPerfil);
            $("#pulicacionesUsuario").append(publicacion);
        }
    }
})
